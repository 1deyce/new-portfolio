        ...
        <section id='portfolio' className='bg-white dark:bg-black pt-20'>
            ...
            >
                <div className="max-w-sm bg-white dark:border-black rounded-2xl dark:bg-black hover:shadow-md">
                        <img
                            className="rounded-2xl pt-1 px-1" 
                            src={Img} 
                            alt="" 
                        />
                    <div className="p-5 text-center">
                            <h5
                                className="mb-2 text-2xl font-bold tracking-tight text-primaryColor dark:text-primaryColor"
                            >
                        ...
                        <a 
                            ...
                            className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white dark:text-black bg-black rounded-lg hover:bg-primaryColor hover:text-black focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-white dark:hover:bg-secondaryColor dark:hover:text-white dark:focus:ring-blue-800 dark:hover:border-2 dark:hover:border-white hover:border-2 hover:border-black"
                        >
                            Read more
